...
const seedDB = async () => {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        const camp = new Campground({
            author: '658fea327d5bbcc3b3263eaa',
            ...
            images: [
                {
                    url: 'https://res.cloudinary.com/drl6ege2h/image/upload/v1704172657/YelpCamp/hmkvb6smtrkyjnnp49y9.jpg',
                    filename: 'YelpCamp/hmkvb6smtrkyjnnp49y9'
                }
            ],
        });
        await camp.save();
